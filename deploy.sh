...
update_download_config() {
    ...
    # Build URLs
    local dmg_version_url="https://github.com/$GITHUB_OWNER/$GITHUB_REPO/releases/download/$tag/$RELEASE_DMG_NAME"
    local dmg_latest_url="https://github.com/$GITHUB_OWNER/$GITHUB_REPO/releases/tag/$tag"
...
export const DOWNLOAD_CONFIG = {
  ...
  dmgVersionUrl: '$dmg_version_url',
  dmgLatestUrl: '$dmg_latest_url',
